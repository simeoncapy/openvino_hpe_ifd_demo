...
static const char flip_video_message[] = "Optional. Flip the video by a multiple of 90°.";
static const char sync_mode[] = "Optional. Use sync mode.";
...
DEFINE_string(f, "0", flip_video_message);
DEFINE_string(s, "0", sync_mode);
...
static void showUsage() {
    ...
    std::cout << "    -f                         " << flip_video_message << std::endl;
    std::cout << "    -s                         " << sync_mode << std::endl;
}
